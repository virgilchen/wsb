...
public class ImagePreProcess3 {  
    ...
    public static Map<BufferedImage, String> loadTrainData() throws Exception {  
        if (trainMap == null) {  
            ...
            File dir = new File(BASE_PATH + "train3");  
    ...
    public static String getSingleCharOcr(BufferedImage img,  
        ...
        int count = 0 ;
        for (int y = 0; y < height; ++y) {  
            if (isBlackB(img.getRGB((width/2) - 1, y)) 
    ...
    public static String getAllOcr(String file) throws Exception {  
        ...
        ImageIO.write(img, "JPG", new File(BASE_PATH + "result3//" + result + ".jpg"));  
        return result;  
    }  
    ...
    public static void downloadImage() {  
        ...
        for (int i = 0; i < 30; i++) {  
            try {  
                ...
                // 读取内容  
                String picName = BASE_PATH + "img3//" + i + ".jpg";  
    ...
    public static void trainData() throws Exception {  
        File dir = new File(BASE_PATH + "temp3");  
        File[] files = dir.listFiles();  
        for (File file : files) {  
            BufferedImage img = removeBackgroud(BASE_PATH + "temp3//" + file.getName());  
            List<BufferedImage> listImg = splitImage(img);  
            if (listImg.size() == 5) {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        // downloadImage();  
        for (int i = 0; i < 3; ++i) {  
            String text = getAllOcr(BASE_PATH + "test5.png");  
